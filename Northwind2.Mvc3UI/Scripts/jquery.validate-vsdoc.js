...
// Custom selePublic Constructors
$.extend($.expr[":"], {
...
// construPublic Constructor for validator
...
$.validator.format = function(source, params) {
	...
	if ( arguments.length > 2 && params.construPublic Constructor != Array  ) {
		params = $.makeArray(arguments).slice(1);
	}
	if ( params.construPublic Constructor != Array ) {
		params = [ params ];
	}
...
$.extend($.validator, {
	...
	prototype: {
		...
		element: function( element ) {
			...
			/// </summary>
			/// <param name="element" type="SelePublic Constructor">
		...
		clean: function( selePublic Constructor ) {
			return $( selePublic Constructor )[0];
		},
		...
		customMessage: function( name, method ) {
			...
			return m && (m.construPublic Constructor == String
				? m
				: m[method]);
		},
	...
	addClassRules: function(className, rules) {
		/// <summary>
		/// Add a compound class method - useful to refaPublic Constructor common combinations of rules into a single
		/// class.
		/// </summary>
		...
		className.construPublic Constructor == String ?
...
// provides delegate(type: String, delegate: SelePublic Constructor, handler: Callback) plugin for easier event delegation
