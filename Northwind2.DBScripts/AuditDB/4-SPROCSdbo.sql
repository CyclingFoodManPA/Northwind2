...
/****** Object:  StoredProcedure [dbo].[usp_LogError]    Script Date: 2/9/2015 2:16:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- information. 
CREATE PROCEDURE [dbo].[usp_LogError] @ErrorLogID [INT] = 0 OUTPUT -- contains the ErrorLogID of the row inserted
AS
  BEGIN
    SET NOCOUNT ON;
